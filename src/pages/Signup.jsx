      ...
      <div className="w-full max-w-[1100px] bg-white rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden relative min-h-[600px]">
        ...
        <div className="w-full md:w-[45%] bg-[#2563eb] p-8 lg:p-14 flex flex-col items-center justify-between text-white relative z-0">
          ...
          <div className="flex flex-col items-center text-center my-auto w-full">
             <h2 className="text-2xl lg:text-3xl font-bold mb-8">Join us at</h2>
          ...
          <div className="text-center w-full mt-auto">
            <p className="text-[13px] text-blue-100 font-medium leading-relaxed opacity-100 max-w-sm mx-auto">
              Create an account and start experiencing the purest hydration from the Himalayas.
            </p>
        ...
        <div className="w-full md:w-[55%] bg-white p-8 lg:p-20 relative z-10 flex items-center">
          ...
          <div className="w-full max-w-[420px] mx-auto relative z-20">
            <h2 className="text-2xl font-black text-gray-800 text-center mb-12">Create your account</h2>
            
            <form className="space-y-6" onSubmit={handleSubmit}>
               <div className="relative group">
                 <label className="text-[13px] font-bold text-gray-700 block mb-2">Full Name</label>
                 <input 
                   type="text" 
                   name="name"
               ...
               <div className="relative group">
                 <label className="text-[13px] font-bold text-gray-700 block mb-2">Password</label>
                 <input 
                   type="password" 
                   name="password"
               ...
               <div className="flex gap-5 pt-8">
                 ...
                 <button type="button" onClick={() => navigate('/login')} className="flex-1 bg-white text-gray-500 border-2 border-gray-200 rounded-full py-3.5 text-[14px] font-bold hover:border-gray-300 hover:text-gray-700 hover:-translate-y-0.5 transition-all active:scale-95">
                   Sign In
                 </button>
               </div>
            </form>
